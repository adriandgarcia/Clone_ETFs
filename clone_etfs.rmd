...
I come up with 145 funds that match. I can then cross reference that list against the list I created above to add the ones I'm missing. I go from 408 matches to 498 matches.
...
write.xlsx(as.data.frame(Strat_df), "pairs.xlsx", sheetName = "Strategy_Pairs", 
  col.names = TRUE, row.names = FALSE, append = FALSE)
write.xlsx(as.data.frame(NameMod_df), "pairs.xlsx", sheetName = "Name_Pairs", 
  col.names = TRUE, row.names = FALSE, append = TRUE)
write.xlsx(as.data.frame(ETF_Pairs), "pairs.xlsx", sheetName = "Combined", 
  col.names = TRUE, row.names = FALSE, append = TRUE)
